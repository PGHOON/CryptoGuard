...
TRACE_SYSCALL(sys_enter_process_vm_readv, "tp_readv")
SEC("tp/syscalls/sys_enter_writev")
TRACE_SYSCALL(sys_enter_writev, "tp_writev")
SEC("tp/syscalls/sys_exit_lremovexattr")
TRACE_SYSCALL(sys_exit_lremovexattr, "tp_lremovexattr")
SEC("tp/syscalls/sys_exit_sethostname")
TRACE_SYSCALL(sys_exit_sethostname, "tp_sethostname")
SEC("tp/syscalls/sys_enter_fstatfs")
TRACE_SYSCALL(sys_enter_fstatfs, "tp_fstatfs")
SEC("tp/syscalls/sys_enter_process_vm_writev")
TRACE_SYSCALL(sys_enter_process_vm_writev, "tp_writev")
SEC("tp/syscalls/sys_exit_accept")
TRACE_SYSCALL(sys_exit_accept, "tp_accept")
SEC("tp/syscalls/sys_exit_lseek")
TRACE_SYSCALL(sys_exit_lseek, "tp_lseek")
SEC("tp/syscalls/sys_exit_setitimer")
TRACE_SYSCALL(sys_exit_setitimer, "tp_setitimer")
SEC("tp/syscalls/sys_enter_fsync")
TRACE_SYSCALL(sys_enter_fsync, "tp_fsync")
SEC("tp/syscalls/sys_enter_pselect6")
TRACE_SYSCALL(sys_enter_pselect6, "tp_pselect6")
SEC("tp/syscalls/sys_exit_accept4")
TRACE_SYSCALL(sys_exit_accept4, "tp_accept4")
SEC("tp/syscalls/sys_exit_lsetxattr")
TRACE_SYSCALL(sys_exit_lsetxattr, "tp_lsetxattr")
SEC("tp/syscalls/sys_exit_setns")
TRACE_SYSCALL(sys_exit_setns, "tp_setns")
...
TRACE_SYSCALL(sys_exit_acct, "tp_acct")
SEC("tp/syscalls/sys_exit_madvise")
TRACE_SYSCALL(sys_exit_madvise, "tp_madvise")
SEC("tp/syscalls/sys_exit_setpgid")
TRACE_SYSCALL(sys_exit_setpgid, "tp_setpgid")
...
TRACE_SYSCALL(sys_exit_add_key, "tp_key")
SEC("tp/syscalls/sys_exit_mbind")
TRACE_SYSCALL(sys_exit_mbind, "tp_mbind")
SEC("tp/syscalls/sys_exit_setpriority")
TRACE_SYSCALL(sys_exit_setpriority, "tp_setpriority")
SEC("tp/syscalls/sys_enter_get_mempolicy")
TRACE_SYSCALL(sys_enter_get_mempolicy, "tp_mempolicy")
SEC("tp/syscalls/sys_enter_pwritev")
TRACE_SYSCALL(sys_enter_pwritev, "tp_pwritev")
SEC("tp/syscalls/sys_exit_adjtimex")
TRACE_SYSCALL(sys_exit_adjtimex, "tp_adjtimex")
SEC("tp/syscalls/sys_exit_membarrier")
TRACE_SYSCALL(sys_exit_membarrier, "tp_membarrier")
SEC("tp/syscalls/sys_exit_setregid")
TRACE_SYSCALL(sys_exit_setregid, "tp_setregid")
SEC("tp/syscalls/sys_enter_get_robust_list")
TRACE_SYSCALL(sys_enter_get_robust_list, "tp_list")
SEC("tp/syscalls/sys_enter_pwritev2")
TRACE_SYSCALL(sys_enter_pwritev2, "tp_pwritev2")
SEC("tp/syscalls/sys_exit_arm64_personality")
TRACE_SYSCALL(sys_exit_arm64_personality, "tp_personality")
SEC("tp/syscalls/sys_exit_memfd_create")
TRACE_SYSCALL(sys_exit_memfd_create, "tp_create")
SEC("tp/syscalls/sys_exit_setresgid")
TRACE_SYSCALL(sys_exit_setresgid, "tp_setresgid")
SEC("tp/syscalls/sys_enter_getcpu")
TRACE_SYSCALL(sys_enter_getcpu, "tp_getcpu")
SEC("tp/syscalls/sys_enter_quotactl")
TRACE_SYSCALL(sys_enter_quotactl, "tp_quotactl")
SEC("tp/syscalls/sys_exit_bind")
TRACE_SYSCALL(sys_exit_bind, "tp_bind")
SEC("tp/syscalls/sys_exit_memfd_secret")
TRACE_SYSCALL(sys_exit_memfd_secret, "tp_secret")
SEC("tp/syscalls/sys_exit_setresuid")
TRACE_SYSCALL(sys_exit_setresuid, "tp_setresuid")
SEC("tp/syscalls/sys_enter_getcwd")
TRACE_SYSCALL(sys_enter_getcwd, "tp_getcwd")
SEC("tp/syscalls/sys_enter_quotactl_fd")
TRACE_SYSCALL(sys_enter_quotactl_fd, "tp_fd")
SEC("tp/syscalls/sys_exit_bpf")
TRACE_SYSCALL(sys_exit_bpf, "tp_bpf")
SEC("tp/syscalls/sys_exit_migrate_pages")
TRACE_SYSCALL(sys_exit_migrate_pages, "tp_pages")
SEC("tp/syscalls/sys_exit_setreuid")
TRACE_SYSCALL(sys_exit_setreuid, "tp_setreuid")
...
TRACE_SYSCALL(sys_exit_brk, "tp_brk")
SEC("tp/syscalls/sys_exit_mincore")
TRACE_SYSCALL(sys_exit_mincore, "tp_mincore")
SEC("tp/syscalls/sys_exit_setrlimit")
TRACE_SYSCALL(sys_exit_setrlimit, "tp_setrlimit")
SEC("tp/syscalls/sys_enter_getegid")
TRACE_SYSCALL(sys_enter_getegid, "tp_getegid")
SEC("tp/syscalls/sys_enter_readahead")
TRACE_SYSCALL(sys_enter_readahead, "tp_readahead")
SEC("tp/syscalls/sys_exit_capget")
TRACE_SYSCALL(sys_exit_capget, "tp_capget")
SEC("tp/syscalls/sys_exit_mkdirat")
TRACE_SYSCALL(sys_exit_mkdirat, "tp_mkdirat")
SEC("tp/syscalls/sys_exit_setsid")
TRACE_SYSCALL(sys_exit_setsid, "tp_setsid")
SEC("tp/syscalls/sys_enter_geteuid")
TRACE_SYSCALL(sys_enter_geteuid, "tp_geteuid")
SEC("tp/syscalls/sys_enter_readlinkat")
TRACE_SYSCALL(sys_enter_readlinkat, "tp_readlinkat")
SEC("tp/syscalls/sys_exit_capset")
TRACE_SYSCALL(sys_exit_capset, "tp_capset")
SEC("tp/syscalls/sys_exit_mknodat")
TRACE_SYSCALL(sys_exit_mknodat, "tp_mknodat")
SEC("tp/syscalls/sys_exit_setsockopt")
TRACE_SYSCALL(sys_exit_setsockopt, "tp_setsockopt")
SEC("tp/syscalls/sys_enter_getgid")
TRACE_SYSCALL(sys_enter_getgid, "tp_getgid")
SEC("tp/syscalls/sys_enter_readv")
TRACE_SYSCALL(sys_enter_readv, "tp_readv")
SEC("tp/syscalls/sys_exit_chdir")
TRACE_SYSCALL(sys_exit_chdir, "tp_chdir")
SEC("tp/syscalls/sys_exit_mlock")
TRACE_SYSCALL(sys_exit_mlock, "tp_mlock")
SEC("tp/syscalls/sys_exit_settimeofday")
TRACE_SYSCALL(sys_exit_settimeofday, "tp_settimeofday")
SEC("tp/syscalls/sys_enter_getgroups")
TRACE_SYSCALL(sys_enter_getgroups, "tp_getgroups")
SEC("tp/syscalls/sys_enter_reboot")
TRACE_SYSCALL(sys_enter_reboot, "tp_reboot")
SEC("tp/syscalls/sys_exit_chroot")
TRACE_SYSCALL(sys_exit_chroot, "tp_chroot")
SEC("tp/syscalls/sys_exit_mlock2")
TRACE_SYSCALL(sys_exit_mlock2, "tp_mlock2")
SEC("tp/syscalls/sys_exit_setuid")
TRACE_SYSCALL(sys_exit_setuid, "tp_setuid")
SEC("tp/syscalls/sys_enter_getitimer")
TRACE_SYSCALL(sys_enter_getitimer, "tp_getitimer")
SEC("tp/syscalls/sys_enter_recvfrom")
TRACE_SYSCALL(sys_enter_recvfrom, "tp_recvfrom")
SEC("tp/syscalls/sys_exit_clock_adjtime")
TRACE_SYSCALL(sys_exit_clock_adjtime, "tp_adjtime")
SEC("tp/syscalls/sys_exit_mlockall")
TRACE_SYSCALL(sys_exit_mlockall, "tp_mlockall")
SEC("tp/syscalls/sys_exit_setxattr")
TRACE_SYSCALL(sys_exit_setxattr, "tp_setxattr")
SEC("tp/syscalls/sys_enter_getpeername")
TRACE_SYSCALL(sys_enter_getpeername, "tp_getpeername")
SEC("tp/syscalls/sys_enter_recvmmsg")
TRACE_SYSCALL(sys_enter_recvmmsg, "tp_recvmmsg")
SEC("tp/syscalls/sys_exit_clock_getres")
TRACE_SYSCALL(sys_exit_clock_getres, "tp_getres")
SEC("tp/syscalls/sys_exit_mmap")
TRACE_SYSCALL(sys_exit_mmap, "tp_mmap")
SEC("tp/syscalls/sys_exit_shmat")
TRACE_SYSCALL(sys_exit_shmat, "tp_shmat")
...
TRACE_SYSCALL(sys_exit_clock_gettime, "tp_gettime")
SEC("tp/syscalls/sys_exit_mount")
TRACE_SYSCALL(sys_exit_mount, "tp_mount")
SEC("tp/syscalls/sys_exit_shmctl")
TRACE_SYSCALL(sys_exit_shmctl, "tp_shmctl")
...
TRACE_SYSCALL(sys_exit_clock_nanosleep, "tp_nanosleep")
SEC("tp/syscalls/sys_exit_mount_setattr")
TRACE_SYSCALL(sys_exit_mount_setattr, "tp_setattr")
SEC("tp/syscalls/sys_exit_shmdt")
TRACE_SYSCALL(sys_exit_shmdt, "tp_shmdt")
SEC("tp/syscalls/sys_enter_getppid")
TRACE_SYSCALL(sys_enter_getppid, "tp_getppid")
SEC("tp/syscalls/sys_enter_removexattr")
TRACE_SYSCALL(sys_enter_removexattr, "tp_removexattr")
SEC("tp/syscalls/sys_exit_clock_settime")
TRACE_SYSCALL(sys_exit_clock_settime, "tp_settime")
SEC("tp/syscalls/sys_exit_move_mount")
TRACE_SYSCALL(sys_exit_move_mount, "tp_mount")
SEC("tp/syscalls/sys_exit_shmget")
TRACE_SYSCALL(sys_exit_shmget, "tp_shmget")
SEC("tp/syscalls/sys_enter_getpriority")
TRACE_SYSCALL(sys_enter_getpriority, "tp_getpriority")
SEC("tp/syscalls/sys_enter_renameat")
TRACE_SYSCALL(sys_enter_renameat, "tp_renameat")
SEC("tp/syscalls/sys_exit_clone")
TRACE_SYSCALL(sys_exit_clone, "tp_clone")
SEC("tp/syscalls/sys_exit_move_pages")
TRACE_SYSCALL(sys_exit_move_pages, "tp_pages")
SEC("tp/syscalls/sys_exit_shutdown")
TRACE_SYSCALL(sys_exit_shutdown, "tp_shutdown")
SEC("tp/syscalls/sys_enter_getrandom")
TRACE_SYSCALL(sys_enter_getrandom, "tp_getrandom")
SEC("tp/syscalls/sys_enter_renameat2")
TRACE_SYSCALL(sys_enter_renameat2, "tp_renameat2")
SEC("tp/syscalls/sys_exit_clone3")
TRACE_SYSCALL(sys_exit_clone3, "tp_clone3")
SEC("tp/syscalls/sys_exit_mprotect")
TRACE_SYSCALL(sys_exit_mprotect, "tp_mprotect")
SEC("tp/syscalls/sys_exit_sigaltstack")
TRACE_SYSCALL(sys_exit_sigaltstack, "tp_sigaltstack")
SEC("tp/syscalls/sys_enter_getresgid")
TRACE_SYSCALL(sys_enter_getresgid, "tp_getresgid")
SEC("tp/syscalls/sys_enter_request_key")
TRACE_SYSCALL(sys_enter_request_key, "tp_key")
SEC("tp/syscalls/sys_exit_close")
TRACE_SYSCALL(sys_exit_close, "tp_close")
SEC("tp/syscalls/sys_exit_mq_getsetattr")
TRACE_SYSCALL(sys_exit_mq_getsetattr, "tp_getsetattr")
SEC("tp/syscalls/sys_exit_signalfd4")
TRACE_SYSCALL(sys_exit_signalfd4, "tp_signalfd4")
SEC("tp/syscalls/sys_enter_getresuid")
TRACE_SYSCALL(sys_enter_getresuid, "tp_getresuid")
SEC("tp/syscalls/sys_enter_restart_syscall")
TRACE_SYSCALL(sys_enter_restart_syscall, "tp_syscall")
SEC("tp/syscalls/sys_exit_close_range")
TRACE_SYSCALL(sys_exit_close_range, "tp_range")
SEC("tp/syscalls/sys_exit_mq_notify")
TRACE_SYSCALL(sys_exit_mq_notify, "tp_notify")
SEC("tp/syscalls/sys_exit_socket")
TRACE_SYSCALL(sys_exit_socket, "tp_socket")
SEC("tp/syscalls/sys_enter_getrlimit")
TRACE_SYSCALL(sys_enter_getrlimit, "tp_getrlimit")
SEC("tp/syscalls/sys_enter_rseq")
TRACE_SYSCALL(sys_enter_rseq, "tp_rseq")
SEC("tp/syscalls/sys_exit_connect")
TRACE_SYSCALL(sys_exit_connect, "tp_connect")
SEC("tp/syscalls/sys_exit_mq_open")
TRACE_SYSCALL(sys_exit_mq_open, "tp_open")
SEC("tp/syscalls/sys_exit_socketpair")
TRACE_SYSCALL(sys_exit_socketpair, "tp_socketpair")
...
TRACE_SYSCALL(sys_exit_copy_file_range, "tp_range")
SEC("tp/syscalls/sys_exit_mq_timedreceive")
TRACE_SYSCALL(sys_exit_mq_timedreceive, "tp_timedreceive")
SEC("tp/syscalls/sys_exit_splice")
TRACE_SYSCALL(sys_exit_splice, "tp_splice")
...
TRACE_SYSCALL(sys_exit_delete_module, "tp_module")
SEC("tp/syscalls/sys_exit_mq_timedsend")
TRACE_SYSCALL(sys_exit_mq_timedsend, "tp_timedsend")
SEC("tp/syscalls/sys_exit_statfs")
TRACE_SYSCALL(sys_exit_statfs, "tp_statfs")
...
TRACE_SYSCALL(sys_exit_dup, "tp_dup")
SEC("tp/syscalls/sys_exit_mq_unlink")
TRACE_SYSCALL(sys_exit_mq_unlink, "tp_unlink")
SEC("tp/syscalls/sys_exit_statx")
TRACE_SYSCALL(sys_exit_statx, "tp_statx")
...
TRACE_SYSCALL(sys_enter_rt_sigqueueinfo, "tp_sigqueueinfo")
SEC("tp/syscalls/sys_exit_dup3")
TRACE_SYSCALL(sys_exit_dup3, "tp_dup3")
SEC("tp/syscalls/sys_exit_mremap")
TRACE_SYSCALL(sys_exit_mremap, "tp_mremap")
SEC("tp/syscalls/sys_exit_swapoff")
TRACE_SYSCALL(sys_exit_swapoff, "tp_swapoff")
SEC("tp/syscalls/sys_enter_gettid")
TRACE_SYSCALL(sys_enter_gettid, "tp_gettid")
SEC("tp/syscalls/sys_enter_rt_sigreturn")
TRACE_SYSCALL(sys_enter_rt_sigreturn, "tp_sigreturn")
SEC("tp/syscalls/sys_exit_epoll_create1")
TRACE_SYSCALL(sys_exit_epoll_create1, "tp_create1")
SEC("tp/syscalls/sys_exit_msgctl")
TRACE_SYSCALL(sys_exit_msgctl, "tp_msgctl")
SEC("tp/syscalls/sys_exit_swapon")
TRACE_SYSCALL(sys_exit_swapon, "tp_swapon")
SEC("tp/syscalls/sys_enter_gettimeofday")
TRACE_SYSCALL(sys_enter_gettimeofday, "tp_gettimeofday")
SEC("tp/syscalls/sys_enter_rt_sigsuspend")
TRACE_SYSCALL(sys_enter_rt_sigsuspend, "tp_sigsuspend")
SEC("tp/syscalls/sys_exit_epoll_ctl")
TRACE_SYSCALL(sys_exit_epoll_ctl, "tp_ctl")
SEC("tp/syscalls/sys_exit_msgget")
TRACE_SYSCALL(sys_exit_msgget, "tp_msgget")
SEC("tp/syscalls/sys_exit_symlinkat")
TRACE_SYSCALL(sys_exit_symlinkat, "tp_symlinkat")
SEC("tp/syscalls/sys_enter_getuid")
TRACE_SYSCALL(sys_enter_getuid, "tp_getuid")
SEC("tp/syscalls/sys_enter_rt_sigtimedwait")
TRACE_SYSCALL(sys_enter_rt_sigtimedwait, "tp_sigtimedwait")
SEC("tp/syscalls/sys_exit_epoll_pwait")
TRACE_SYSCALL(sys_exit_epoll_pwait, "tp_pwait")
SEC("tp/syscalls/sys_exit_msgrcv")
TRACE_SYSCALL(sys_exit_msgrcv, "tp_msgrcv")
SEC("tp/syscalls/sys_exit_sync")
TRACE_SYSCALL(sys_exit_sync, "tp_sync")
SEC("tp/syscalls/sys_enter_getxattr")
TRACE_SYSCALL(sys_enter_getxattr, "tp_getxattr")
SEC("tp/syscalls/sys_enter_rt_tgsigqueueinfo")
TRACE_SYSCALL(sys_enter_rt_tgsigqueueinfo, "tp_tgsigqueueinfo")
SEC("tp/syscalls/sys_exit_epoll_pwait2")
TRACE_SYSCALL(sys_exit_epoll_pwait2, "tp_pwait2")
SEC("tp/syscalls/sys_exit_msgsnd")
TRACE_SYSCALL(sys_exit_msgsnd, "tp_msgsnd")
SEC("tp/syscalls/sys_exit_sync_file_range")
TRACE_SYSCALL(sys_exit_sync_file_range, "tp_range")
SEC("tp/syscalls/sys_enter_init_module")
TRACE_SYSCALL(sys_enter_init_module, "tp_module")
SEC("tp/syscalls/sys_enter_sched_get_priority_max")
TRACE_SYSCALL(sys_enter_sched_get_priority_max, "tp_max")
SEC("tp/syscalls/sys_exit_eventfd2")
TRACE_SYSCALL(sys_exit_eventfd2, "tp_eventfd2")
SEC("tp/syscalls/sys_exit_msync")
TRACE_SYSCALL(sys_exit_msync, "tp_msync")
SEC("tp/syscalls/sys_exit_syncfs")
TRACE_SYSCALL(sys_exit_syncfs, "tp_syncfs")
SEC("tp/syscalls/sys_enter_inotify_add_watch")
TRACE_SYSCALL(sys_enter_inotify_add_watch, "tp_watch")
SEC("tp/syscalls/sys_enter_sched_get_priority_min")
TRACE_SYSCALL(sys_enter_sched_get_priority_min, "tp_min")
SEC("tp/syscalls/sys_exit_execve")
TRACE_SYSCALL(sys_exit_execve, "tp_execve")
SEC("tp/syscalls/sys_exit_munlock")
TRACE_SYSCALL(sys_exit_munlock, "tp_munlock")
SEC("tp/syscalls/sys_exit_sysinfo")
TRACE_SYSCALL(sys_exit_sysinfo, "tp_sysinfo")
SEC("tp/syscalls/sys_enter_inotify_init1")
TRACE_SYSCALL(sys_enter_inotify_init1, "tp_init1")
SEC("tp/syscalls/sys_enter_sched_getaffinity")
TRACE_SYSCALL(sys_enter_sched_getaffinity, "tp_getaffinity")
SEC("tp/syscalls/sys_exit_execveat")
TRACE_SYSCALL(sys_exit_execveat, "tp_execveat")
SEC("tp/syscalls/sys_exit_munlockall")
TRACE_SYSCALL(sys_exit_munlockall, "tp_munlockall")
SEC("tp/syscalls/sys_exit_syslog")
TRACE_SYSCALL(sys_exit_syslog, "tp_syslog")
SEC("tp/syscalls/sys_enter_inotify_rm_watch")
TRACE_SYSCALL(sys_enter_inotify_rm_watch, "tp_watch")
SEC("tp/syscalls/sys_enter_sched_getattr")
TRACE_SYSCALL(sys_enter_sched_getattr, "tp_getattr")
SEC("tp/syscalls/sys_exit_exit")
TRACE_SYSCALL(sys_exit_exit, "tp_exit")
SEC("tp/syscalls/sys_exit_munmap")
TRACE_SYSCALL(sys_exit_munmap, "tp_munmap")
SEC("tp/syscalls/sys_exit_tee")
TRACE_SYSCALL(sys_exit_tee, "tp_tee")
SEC("tp/syscalls/sys_enter_io_cancel")
TRACE_SYSCALL(sys_enter_io_cancel, "tp_cancel")
SEC("tp/syscalls/sys_enter_sched_getparam")
TRACE_SYSCALL(sys_enter_sched_getparam, "tp_getparam")
SEC("tp/syscalls/sys_exit_exit_group")
TRACE_SYSCALL(sys_exit_exit_group, "tp_group")
SEC("tp/syscalls/sys_exit_name_to_handle_at")
TRACE_SYSCALL(sys_exit_name_to_handle_at, "tp_at")
SEC("tp/syscalls/sys_exit_tgkill")
TRACE_SYSCALL(sys_exit_tgkill, "tp_tgkill")
SEC("tp/syscalls/sys_enter_io_destroy")
TRACE_SYSCALL(sys_enter_io_destroy, "tp_destroy")
SEC("tp/syscalls/sys_enter_sched_getscheduler")
TRACE_SYSCALL(sys_enter_sched_getscheduler, "tp_getscheduler")
SEC("tp/syscalls/sys_exit_faccessat")
TRACE_SYSCALL(sys_exit_faccessat, "tp_faccessat")
SEC("tp/syscalls/sys_exit_nanosleep")
TRACE_SYSCALL(sys_exit_nanosleep, "tp_nanosleep")
SEC("tp/syscalls/sys_exit_timer_create")
TRACE_SYSCALL(sys_exit_timer_create, "tp_create")
SEC("tp/syscalls/sys_enter_io_getevents")
TRACE_SYSCALL(sys_enter_io_getevents, "tp_getevents")
SEC("tp/syscalls/sys_enter_sched_rr_get_interval")
TRACE_SYSCALL(sys_enter_sched_rr_get_interval, "tp_interval")
SEC("tp/syscalls/sys_exit_faccessat2")
TRACE_SYSCALL(sys_exit_faccessat2, "tp_faccessat2")
SEC("tp/syscalls/sys_exit_newfstat")
TRACE_SYSCALL(sys_exit_newfstat, "tp_newfstat")
SEC("tp/syscalls/sys_exit_timer_delete")
TRACE_SYSCALL(sys_exit_timer_delete, "tp_delete")
SEC("tp/syscalls/sys_enter_io_pgetevents")
TRACE_SYSCALL(sys_enter_io_pgetevents, "tp_pgetevents")
SEC("tp/syscalls/sys_enter_sched_setaffinity")
TRACE_SYSCALL(sys_enter_sched_setaffinity, "tp_setaffinity")
SEC("tp/syscalls/sys_exit_fadvise64_64")
TRACE_SYSCALL(sys_exit_fadvise64_64, "tp_64")
SEC("tp/syscalls/sys_exit_newfstatat")
TRACE_SYSCALL(sys_exit_newfstatat, "tp_newfstatat")
SEC("tp/syscalls/sys_exit_timer_getoverrun")
TRACE_SYSCALL(sys_exit_timer_getoverrun, "tp_getoverrun")
SEC("tp/syscalls/sys_enter_io_setup")
TRACE_SYSCALL(sys_enter_io_setup, "tp_setup")
SEC("tp/syscalls/sys_enter_sched_setattr")
TRACE_SYSCALL(sys_enter_sched_setattr, "tp_setattr")
SEC("tp/syscalls/sys_exit_fallocate")
TRACE_SYSCALL(sys_exit_fallocate, "tp_fallocate")
SEC("tp/syscalls/sys_exit_newuname")
TRACE_SYSCALL(sys_exit_newuname, "tp_newuname")
SEC("tp/syscalls/sys_exit_timer_gettime")
TRACE_SYSCALL(sys_exit_timer_gettime, "tp_gettime")
SEC("tp/syscalls/sys_enter_io_submit")
TRACE_SYSCALL(sys_enter_io_submit, "tp_submit")
SEC("tp/syscalls/sys_enter_sched_setparam")
TRACE_SYSCALL(sys_enter_sched_setparam, "tp_setparam")
SEC("tp/syscalls/sys_exit_fanotify_init")
TRACE_SYSCALL(sys_exit_fanotify_init, "tp_init")
SEC("tp/syscalls/sys_exit_open_by_handle_at")
TRACE_SYSCALL(sys_exit_open_by_handle_at, "tp_at")
SEC("tp/syscalls/sys_exit_timer_settime")
TRACE_SYSCALL(sys_exit_timer_settime, "tp_settime")
SEC("tp/syscalls/sys_enter_io_uring_enter")
TRACE_SYSCALL(sys_enter_io_uring_enter, "tp_enter")
SEC("tp/syscalls/sys_enter_sched_setscheduler")
TRACE_SYSCALL(sys_enter_sched_setscheduler, "tp_setscheduler")
SEC("tp/syscalls/sys_exit_fanotify_mark")
TRACE_SYSCALL(sys_exit_fanotify_mark, "tp_mark")
SEC("tp/syscalls/sys_exit_open_tree")
TRACE_SYSCALL(sys_exit_open_tree, "tp_tree")
SEC("tp/syscalls/sys_exit_timerfd_create")
TRACE_SYSCALL(sys_exit_timerfd_create, "tp_create")
SEC("tp/syscalls/sys_enter_io_uring_register")
TRACE_SYSCALL(sys_enter_io_uring_register, "tp_register")
SEC("tp/syscalls/sys_enter_sched_yield")
TRACE_SYSCALL(sys_enter_sched_yield, "tp_yield")
SEC("tp/syscalls/sys_exit_fchdir")
TRACE_SYSCALL(sys_exit_fchdir, "tp_fchdir")
SEC("tp/syscalls/sys_exit_openat")
TRACE_SYSCALL(sys_exit_openat, "tp_openat")
SEC("tp/syscalls/sys_exit_timerfd_gettime")
TRACE_SYSCALL(sys_exit_timerfd_gettime, "tp_gettime")
SEC("tp/syscalls/sys_enter_io_uring_setup")
TRACE_SYSCALL(sys_enter_io_uring_setup, "tp_setup")
SEC("tp/syscalls/sys_enter_seccomp")
TRACE_SYSCALL(sys_enter_seccomp, "tp_seccomp")
SEC("tp/syscalls/sys_exit_fchmod")
TRACE_SYSCALL(sys_exit_fchmod, "tp_fchmod")
SEC("tp/syscalls/sys_exit_openat2")
TRACE_SYSCALL(sys_exit_openat2, "tp_openat2")
SEC("tp/syscalls/sys_exit_timerfd_settime")
TRACE_SYSCALL(sys_exit_timerfd_settime, "tp_settime")
SEC("tp/syscalls/sys_enter_ioctl")
TRACE_SYSCALL(sys_enter_ioctl, "tp_ioctl")
SEC("tp/syscalls/sys_enter_semctl")
TRACE_SYSCALL(sys_enter_semctl, "tp_semctl")
SEC("tp/syscalls/sys_exit_fchmodat")
TRACE_SYSCALL(sys_exit_fchmodat, "tp_fchmodat")
SEC("tp/syscalls/sys_exit_perf_event_open")
TRACE_SYSCALL(sys_exit_perf_event_open, "tp_open")
SEC("tp/syscalls/sys_exit_times")
TRACE_SYSCALL(sys_exit_times, "tp_times")
SEC("tp/syscalls/sys_enter_ioprio_get")
TRACE_SYSCALL(sys_enter_ioprio_get, "tp_get")
SEC("tp/syscalls/sys_enter_semget")
TRACE_SYSCALL(sys_enter_semget, "tp_semget")
SEC("tp/syscalls/sys_exit_fchown")
TRACE_SYSCALL(sys_exit_fchown, "tp_fchown")
SEC("tp/syscalls/sys_exit_pidfd_getfd")
TRACE_SYSCALL(sys_exit_pidfd_getfd, "tp_getfd")
SEC("tp/syscalls/sys_exit_tkill")
TRACE_SYSCALL(sys_exit_tkill, "tp_tkill")
SEC("tp/syscalls/sys_enter_ioprio_set")
TRACE_SYSCALL(sys_enter_ioprio_set, "tp_set")
SEC("tp/syscalls/sys_enter_semop")
TRACE_SYSCALL(sys_enter_semop, "tp_semop")
SEC("tp/syscalls/sys_exit_fchownat")
TRACE_SYSCALL(sys_exit_fchownat, "tp_fchownat")
SEC("tp/syscalls/sys_exit_pidfd_open")
TRACE_SYSCALL(sys_exit_pidfd_open, "tp_open")
SEC("tp/syscalls/sys_exit_truncate")
TRACE_SYSCALL(sys_exit_truncate, "tp_truncate")
SEC("tp/syscalls/sys_enter_kcmp")
TRACE_SYSCALL(sys_enter_kcmp, "tp_kcmp")
SEC("tp/syscalls/sys_enter_semtimedop")
TRACE_SYSCALL(sys_enter_semtimedop, "tp_semtimedop")
SEC("tp/syscalls/sys_exit_fcntl")
TRACE_SYSCALL(sys_exit_fcntl, "tp_fcntl")
SEC("tp/syscalls/sys_exit_pidfd_send_signal")
TRACE_SYSCALL(sys_exit_pidfd_send_signal, "tp_signal")
SEC("tp/syscalls/sys_exit_umask")
TRACE_SYSCALL(sys_exit_umask, "tp_umask")
SEC("tp/syscalls/sys_enter_kexec_file_load")
TRACE_SYSCALL(sys_enter_kexec_file_load, "tp_load")
SEC("tp/syscalls/sys_enter_sendfile64")
TRACE_SYSCALL(sys_enter_sendfile64, "tp_sendfile64")
SEC("tp/syscalls/sys_exit_fdatasync")
TRACE_SYSCALL(sys_exit_fdatasync, "tp_fdatasync")
SEC("tp/syscalls/sys_exit_pipe2")
TRACE_SYSCALL(sys_exit_pipe2, "tp_pipe2")
SEC("tp/syscalls/sys_exit_umount")
TRACE_SYSCALL(sys_exit_umount, "tp_umount")
SEC("tp/syscalls/sys_enter_kexec_load")
TRACE_SYSCALL(sys_enter_kexec_load, "tp_load")
SEC("tp/syscalls/sys_enter_sendmmsg")
TRACE_SYSCALL(sys_enter_sendmmsg, "tp_sendmmsg")
SEC("tp/syscalls/sys_exit_fgetxattr")
TRACE_SYSCALL(sys_exit_fgetxattr, "tp_fgetxattr")
SEC("tp/syscalls/sys_exit_pivot_root")
TRACE_SYSCALL(sys_exit_pivot_root, "tp_root")
SEC("tp/syscalls/sys_exit_unlinkat")
TRACE_SYSCALL(sys_exit_unlinkat, "tp_unlinkat")
SEC("tp/syscalls/sys_enter_keyctl")
TRACE_SYSCALL(sys_enter_keyctl, "tp_keyctl")
SEC("tp/syscalls/sys_enter_sendmsg")
TRACE_SYSCALL(sys_enter_sendmsg, "tp_sendmsg")
SEC("tp/syscalls/sys_exit_finit_module")
TRACE_SYSCALL(sys_exit_finit_module, "tp_module")
SEC("tp/syscalls/sys_exit_ppoll")
TRACE_SYSCALL(sys_exit_ppoll, "tp_ppoll")
SEC("tp/syscalls/sys_exit_unshare")
TRACE_SYSCALL(sys_exit_unshare, "tp_unshare")
SEC("tp/syscalls/sys_enter_kill")
TRACE_SYSCALL(sys_enter_kill, "tp_kill")
SEC("tp/syscalls/sys_enter_sendto")
TRACE_SYSCALL(sys_enter_sendto, "tp_sendto")
SEC("tp/syscalls/sys_exit_flistxattr")
TRACE_SYSCALL(sys_exit_flistxattr, "tp_flistxattr")
SEC("tp/syscalls/sys_exit_prctl")
TRACE_SYSCALL(sys_exit_prctl, "tp_prctl")
SEC("tp/syscalls/sys_exit_userfaultfd")
TRACE_SYSCALL(sys_exit_userfaultfd, "tp_userfaultfd")
SEC("tp/syscalls/sys_enter_landlock_add_rule")
TRACE_SYSCALL(sys_enter_landlock_add_rule, "tp_rule")
SEC("tp/syscalls/sys_enter_set_mempolicy")
TRACE_SYSCALL(sys_enter_set_mempolicy, "tp_mempolicy")
SEC("tp/syscalls/sys_exit_flock")
TRACE_SYSCALL(sys_exit_flock, "tp_flock")
SEC("tp/syscalls/sys_exit_pread64")
TRACE_SYSCALL(sys_exit_pread64, "tp_pread64")
SEC("tp/syscalls/sys_exit_utimensat")
TRACE_SYSCALL(sys_exit_utimensat, "tp_utimensat")
SEC("tp/syscalls/sys_enter_landlock_create_ruleset")
TRACE_SYSCALL(sys_enter_landlock_create_ruleset, "tp_ruleset")
SEC("tp/syscalls/sys_enter_set_robust_list")
TRACE_SYSCALL(sys_enter_set_robust_list, "tp_list")
SEC("tp/syscalls/sys_exit_fremovexattr")
TRACE_SYSCALL(sys_exit_fremovexattr, "tp_fremovexattr")
SEC("tp/syscalls/sys_exit_preadv")
TRACE_SYSCALL(sys_exit_preadv, "tp_preadv")
SEC("tp/syscalls/sys_exit_vhangup")
TRACE_SYSCALL(sys_exit_vhangup, "tp_vhangup")
SEC("tp/syscalls/sys_enter_landlock_restrict_self")
TRACE_SYSCALL(sys_enter_landlock_restrict_self, "tp_self")
SEC("tp/syscalls/sys_enter_set_tid_address")
TRACE_SYSCALL(sys_enter_set_tid_address, "tp_address")
SEC("tp/syscalls/sys_exit_fsconfig")
TRACE_SYSCALL(sys_exit_fsconfig, "tp_fsconfig")
SEC("tp/syscalls/sys_exit_preadv2")
TRACE_SYSCALL(sys_exit_preadv2, "tp_preadv2")
SEC("tp/syscalls/sys_exit_vmsplice")
TRACE_SYSCALL(sys_exit_vmsplice, "tp_vmsplice")
SEC("tp/syscalls/sys_enter_lgetxattr")
TRACE_SYSCALL(sys_enter_lgetxattr, "tp_lgetxattr")
SEC("tp/syscalls/sys_enter_setdomainname")
TRACE_SYSCALL(sys_enter_setdomainname, "tp_setdomainname")
SEC("tp/syscalls/sys_exit_fsetxattr")
TRACE_SYSCALL(sys_exit_fsetxattr, "tp_fsetxattr")
SEC("tp/syscalls/sys_exit_prlimit64")
TRACE_SYSCALL(sys_exit_prlimit64, "tp_prlimit64")
SEC("tp/syscalls/sys_exit_wait4")
TRACE_SYSCALL(sys_exit_wait4, "tp_wait4")
SEC("tp/syscalls/sys_enter_linkat")
TRACE_SYSCALL(sys_enter_linkat, "tp_linkat")
SEC("tp/syscalls/sys_enter_setfsgid")
TRACE_SYSCALL(sys_enter_setfsgid, "tp_setfsgid")
SEC("tp/syscalls/sys_exit_fsmount")
TRACE_SYSCALL(sys_exit_fsmount, "tp_fsmount")
SEC("tp/syscalls/sys_exit_process_madvise")
TRACE_SYSCALL(sys_exit_process_madvise, "tp_madvise")
SEC("tp/syscalls/sys_exit_waitid")
TRACE_SYSCALL(sys_exit_waitid, "tp_waitid")
SEC("tp/syscalls/sys_enter_listen")
TRACE_SYSCALL(sys_enter_listen, "tp_listen")
SEC("tp/syscalls/sys_enter_setfsuid")
TRACE_SYSCALL(sys_enter_setfsuid, "tp_setfsuid")
SEC("tp/syscalls/sys_exit_fsopen")
TRACE_SYSCALL(sys_exit_fsopen, "tp_fsopen")
SEC("tp/syscalls/sys_exit_process_mrelease")
TRACE_SYSCALL(sys_exit_process_mrelease, "tp_mrelease")
SEC("tp/syscalls/sys_exit_write")
TRACE_SYSCALL(sys_exit_write, "tp_write")
SEC("tp/syscalls/sys_enter_listxattr")
TRACE_SYSCALL(sys_enter_listxattr, "tp_listxattr")
SEC("tp/syscalls/sys_enter_setgid")
TRACE_SYSCALL(sys_enter_setgid, "tp_setgid")
SEC("tp/syscalls/sys_exit_fspick")
TRACE_SYSCALL(sys_exit_fspick, "tp_fspick")
SEC("tp/syscalls/sys_exit_process_vm_readv")
TRACE_SYSCALL(sys_exit_process_vm_readv, "tp_readv")
SEC("tp/syscalls/sys_exit_writev")
TRACE_SYSCALL(sys_exit_writev, "tp_writev")
